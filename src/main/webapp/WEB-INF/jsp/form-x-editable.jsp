...
<![endif]-->
		...
		<link href="<%=path%>/resources/assets/plugins/editable/css/bootstrap-editable.css" rel="stylesheet">
...
<body>
				            ...
				            <table id="user" class="table table-bordered table-striped" style="clear: both">
				                <tbody> 
				                    ...
				                    <tr>         
				                        ...
				                        <td><a href="form-x-editable.html#" id="dob" data-type="combodate" data-value="2014-05-10" data-format="YYYY-MM-DD" data-viewformat="DD/MM/YYYY" data-template="D / MMM / YYYY" data-pk="1"  data-original-title="Select Date of birth"></a></td>
				                    </tr> 
				                    <tr>         
				                    ...
				                    <tr>         
				                        ...
				                        <td><a href="form-x-editable.html#" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments">Icon touch
				user!</a></td>
				                    </tr> 
	...
	<script src="<%=path%>/resources/assets/plugins/mockjax/jquery.mockjax.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/editable/js/bootstrap-editable.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/moment/moment.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/editable/inputs-ext/typeaheadjs/typeaheadjs.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/editable/inputs-ext/address/address.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/form-x-editable-demo.js"></script>
	<script src="<%=path%>/resources/assets/js/pages/form-x-editable.js"></script>
