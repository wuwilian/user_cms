...
<![endif]-->
	    ...
	    <!-- Css files -->
	    <link href="<%=path%>/resources/<%=path%>/resources/assets/css/bootstrap.min.css" rel="stylesheet">		
...
<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="browserStat big">
								<img src="<%=path%>/resources/assets/img/browser-chrome-big.png" alt="Chrome">
								<span>34%</span>
							</div>
							<div class="browserStat big">
								<img src="<%=path%>/resources/assets/img/browser-firefox-big.png" alt="Firefox">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=path%>/resources/assets/img/browser-ie.png" alt="Internet Explorer">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=path%>/resources/assets/img/browser-safari.png" alt="Safari">
								<span>34%</span>
							</div>
							<div class="browserStat">
								<img src="<%=path%>/resources/assets/img/browser-opera.png" alt="Opera">
								<span>34%</span>
							</div>	
						</div>
					</div>
	...
	<![endif]-->
	<script src="<%=path%>/resources/assets/plugins/easypiechart/js/jquery.easypiechart.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/raphael/raphael.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/justgage/justgage.1.0.1.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/charts-other.js"></script>
