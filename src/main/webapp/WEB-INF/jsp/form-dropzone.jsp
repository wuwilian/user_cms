...
<![endif]-->
		...
		<link href="<%=path%>/resources/assets/plugins/dropzone/css/dropzone.css" rel="stylesheet">
...
<body>
	...
	<script src="<%=path%>/resources/assets/plugins/dropzone/js/dropzone.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/form-dropzone.js"></script>
