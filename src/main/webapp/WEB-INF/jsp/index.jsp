...
<![endif]-->
		...
		<link href="<%=path%>/resources/assets/plugins/xcharts/css/xcharts.min.css" rel=" stylesheet">		
		<link href="<%=path%>/resources/assets/plugins/fullcalendar/css/fullcalendar.css" rel="stylesheet">
		<link href="<%=path%>/resources/assets/plugins/morris/css/morris.css" rel="stylesheet">
		<link href="<%=path%>/resources/assets/plugins/jquery-ui/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
		<link href="<%=path%>/resources/assets/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">	    
...
<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/Germany.png" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/India.png" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/Spain.png" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
									...
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/Russia.png" style="height:18px; margin-top:-2px;"></td>
										<td>Russia</td>
										<td>1258</td>
										<td>958</td>
										<td>
									...
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/usa.png" style="height:18px; margin-top:-2px;"></td>
										<td>USA</td>
										<td>4856</td>
										<td>3621</td>
										<td>
									...
									<tr>
										<td><img src="<%=path%>/resources/assets/ico/flags/brazil.png" style="height:18px; margin-top:-2px;"></td>
										<td>Brazil</td>
										<td>265</td>
										<td>102</td>
										<td>
	...
	<script src="<%=path%>/resources/assets/plugins/touchpunch/jquery.ui.touch-punch.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/moment/moment.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/fullcalendar/js/fullcalendar.min.js"></script>
	<!--[if lte IE 8]>
		<script language="javascript" type="text/javascript" src="<%=path%>/resources/assets/plugins/excanvas/excanvas.min.js"></script>
	<![endif]-->
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.pie.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.stack.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.resize.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.time.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/flot/jquery.flot.spline.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/xcharts/js/xcharts.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/autosize/jquery.autosize.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/placeholder/jquery.placeholder.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/datatables/js/jquery.dataTables.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/datatables/js/dataTables.bootstrap.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/raphael/raphael.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/morris/js/morris.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js"></script>
	<script src="<%=path%>/resources/assets/plugins/jvectormap/js/gdp-data.js"></script>	
	<script src="<%=path%>/resources/assets/plugins/gauge/gauge.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/plugins/d3/d3.min.js"></script>	
	
	<!-- inline scripts related to this page -->
	<script src="<%=path%>/resources/assets/js/pages/index.js"></script>	
