...
<body>
			...
			<div id="content2" class="col-sm-12 full">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-xs-6 col-xs-offset-3 login-box-locked">
						...
						<img src="<%=path%>/resources/assets/img/avatar.jpg" class="avatar img-responsive img-circle"/>
	...
	<!-- page scripts -->
	<script src="<%=path%>/resources/assets/plugins/backstretch/jquery.backstretch.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/page-lockscreen2.js"></script>
