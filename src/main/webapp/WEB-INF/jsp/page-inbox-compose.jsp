...
<![endif]-->
		...
		<link href="<%=path%>/resources/assets/plugins/select2/css/select2.css" rel="stylesheet">	  
...
<body>
				...
				<div class="col-md-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<ul>
								...
								<li>
									<a href="page-inbox-compose.html#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.html#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body contacts">
							...
							<a href="page-inbox-compose.html#" class="btn btn-primary btn-block"> + Contact</a>
							...
							<div class="col-sm-11 col-sm-offset-1">
								...
								<div class="btn-toolbar" role="toolbar">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="page-inbox-compose.html#">add label <span class="label label-danger">Work</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-info">Private</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-success">Clients</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-danger">Travel</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-success">Promotion</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-warning">News</span></a></li>
											<li><a href="page-inbox-compose.html#">add label <span class="label label-info">Update</span></a></li>
										</ul>
									</div>
	...
	<script src="<%=path%>/resources/assets/js/pages/page-inbox-compose.js"></script>
