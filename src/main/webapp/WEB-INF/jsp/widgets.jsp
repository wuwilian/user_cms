...
<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body no-padding">
							<ul class="users-list">
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Lucas" src="<%=path%>/resources/assets/img/avatar.jpg">
									</a>
									<div class="name">Jhon Smith 
										<div class="dropdown pull-right">
											<a class="fa fa-comments" data-toggle="dropdown" href="widgets.html#"></a>
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												<li><a href="widgets.html#"><i class="fa fa-facebook"></i> Facebook</a></li>
												<li><a href="widgets.html#"><i class="fa fa-twitter"></i> Twitter</a></li>
												<li><a href="widgets.html#"><i class="fa fa-skype"></i> Skype</a></li>
												<li><a href="widgets.html#"><i class="fa fa-instagram"></i> Instagram</a></li>
											</ul>
										</div>
									</div>
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Bill" src="<%=path%>/resources/assets/img/avatar7.jpg">
									</a>
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Jane" src="<%=path%>/resources/assets/img/avatar3.jpg">
									</a>
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Kate" src="<%=path%>/resources/assets/img/avatar2.jpg">
									</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body no-padding">
							<ul class="comments-list">
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Bill" src="<%=path%>/resources/assets/img/avatar1.jpg">
									</a>
									<div>
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Jane" src="<%=path%>/resources/assets/img/avatar5.jpg">
									</a>
									<div>
								...
								<li>
									<a href="widgets.html#">
										<img class="avatar" alt="Kate" src="<%=path%>/resources/assets/img/avatar7.jpg">
									</a>
									<div>
	...
	<script src="<%=path%>/resources/assets/plugins/sparkline/jquery.sparkline.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/widgets.js"></script>
