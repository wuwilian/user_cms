...
<body>
				...
				<div class="col-md-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<a href="page-inbox-compose.html" class="btn btn-danger btn-block">Compose</a>

							<ul>
								<li>
									<a href="page-inbox.html#">Inbox<span class="label label-danger">10</span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Stared</a>
								</li>
								<li>
									<a href="page-inbox.html#"></i>Sent Mail</a>
								</li>
								<li>
									<a href="page-inbox.html#">Important<span class="label label-info">7</span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Draft<span class="label label-warning">3</span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Trash</a>
								</li>
								...
								<li>
									<a href="page-inbox.html#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox.html#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body contacts">
							...
							<a href="page-inbox.html#" class="btn btn-primary btn-block"> + Contact</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="page-inbox.html#">add label <span class="label label-danger">Work</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-info">Private</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-success">Clients</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-danger">Travel</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-success">Promotion</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-warning">News</span></a></li>
									<li><a href="page-inbox.html#">add label <span class="label label-info">Update</span></a></li>
								</ul>
							</span>
	...
	<script src="<%=path%>/resources/assets/js/pages/page-inbox.js"></script>
