...
<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="panel-actions">
								<a href="index.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="index.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="index.html#" class="btn-close"><i class="fa fa-times black"></i></a>
							</div>
						</div>
						...
						<div class="panel-body">
							<table class="table table-bordered table-striped">
								...
								<tr>
									<td>Popover</td>
									<td>
										<a href="ui-elements.html#" class="btn btn-warning" data-toggle="popover" title="A Title" data-content="And here's some amazing content. It's very engaging. right?">Click to toggle popover</a>
									</td>
								</tr>
								<tr>
									<td>Dialog</td>
									<td>
										<a href="ui-elements.html#" class="btn btn-success btn-setting">Click for dialog</a>
									</td>
								</tr>
								<tr>
									<td>Tooltip</td>
									<td>
										<a href="ui-elements.html#" title="Tooltip, you can change the position." data-rel="tooltip" class="btn btn-danger">Hover for tooltip</a>
									</td>
								</tr>
							</table>
						</div>	
	...
	<script src="<%=path%>/resources/assets/js/pages/ui-elements.js"></script>
