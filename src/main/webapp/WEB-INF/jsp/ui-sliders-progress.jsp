...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="ui-sliders-progress.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="ui-sliders-progress.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
			</ul>
	...
	<script src="<%=path%>/resources/assets/js/pages/ui-sliders-progress.js"></script>
