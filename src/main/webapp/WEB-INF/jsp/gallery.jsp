					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="row">
									...
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo1.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo2.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo3.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo4.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo5.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo6.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo7.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo8.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo9.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo10.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo11.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo12.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo13.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo14.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="<%=path%>/resources/assets/img/gallery/photo15.jpg" alt="Sample Image">
								</div>
															</div>
						</div>	
					</div><!--/col-->
