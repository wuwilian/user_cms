...
<![endif]-->
		...
		<link href="<%=path%>/resources/assets/plugins/chosen/css/chosen.css" rel="stylesheet">
...
<body>
	...
	<script src="<%=path%>/resources/assets/plugins/chosen/js/chosen.jquery.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/plugins/maskedinput/jquery.maskedinput.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/inputlimiter/js/jquery.inputlimiter.1.3.1.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/datepicker/js/bootstrap-datepicker.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/timepicker/js/bootstrap-timepicker.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/moment/moment.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/daterangepicker/js/daterangepicker.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/hotkeys/jquery.hotkeys.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/wysiwyg/bootstrap-wysiwyg.min.js"></script>
	<script src="<%=path%>/resources/assets/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
	...
	<script src="<%=path%>/resources/assets/js/pages/form-elements.js"></script>
