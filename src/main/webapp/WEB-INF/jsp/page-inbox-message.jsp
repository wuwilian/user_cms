					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<ul>
								...
								<li>
									<a href="page-inbox-message.html#">Stared</a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Sent Mail</a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Important<span class="label label-info">7</span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Draft<span class="label label-warning">3</span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Trash</a>
								</li>
								...
								<li>
									<a href="page-inbox-message.html#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.html#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body message">
							...
							<div class="header">
								...
								<img class="avatar" src="<%=path%>/resources/assets/img/avatar.jpg">
